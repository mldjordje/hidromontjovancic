...
export default function ContactForm({
  ...
  const resolvedSelectLabel = selectLabel || "Tip usluge (nije obavezno)";
  const resolvedSelectPlaceholder = selectPlaceholder || "Izaberite tip usluge";
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="flex flex-col gap-2 text-sm font-semibold text-dark">
          ...
          <input
            ...
            name="subject"
            className="rounded-lg border border-black/10 bg-gray-50 px-3 py-2 text-sm outline-none focus:border-primary"
            placeholder={subjectPlaceholder || "Opis usluge..."}
